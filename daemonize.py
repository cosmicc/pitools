...
def main():
    ...
    if args.high:
        subprocess.Popen(['nohup','nice','-n-10','/usr/bin/python3',pscript], stdout=subprocess.PIPE)
    elif args.low:
        subprocess.Popen(['nohup','nice','-n10','/usr/bin/python3',pscript], stdout=subprocess.PIPE)
    else:
